...
export const CoachSignupForm = ({ onSuccess, onBack }: CoachSignupFormProps) => {
  ...
  return (
    <div className={loading ? "opacity-50 pointer-events-none transition-opacity duration-300" : "transition-opacity duration-300"}>
      ...
      <div className="flex items-center mb-4">
        ...
        <h3 className="text-lg font-semibold">Coach Registration</h3>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="coach-displayName">Display Name</Label>
            <Input
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="coach-sport">Primary Sport</Label>
            <Select onValueChange={(value) => setFormData(prev => ({ ...prev, sport: value }))}>
              <SelectTrigger id="coach-sport">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setFormData(prev => ({ ...prev, experience: value }))}>
              <SelectTrigger id="coach-experience">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="coach-organization">Organization/Team</Label>
            <Input
              id="coach-organization"
          ...
          <div className="space-y-2">
            <Label htmlFor="coach-phoneNumber">Phone Number</Label>
            <Input
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g., Youth training, Performance coaching, Rehabilitation"
        ...
        <div className="space-y-2">
          <Label htmlFor="coach-certifications">Certifications & Qualifications</Label>
          <Textarea
            id="coach-certifications"
            placeholder="List your coaching certifications, qualifications, and relevant education..."
